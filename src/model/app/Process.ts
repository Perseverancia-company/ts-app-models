...
export default class Process extends Model<
	InferAttributes<Process>,
	InferCreationAttributes<Process, { omit: "createdAt" | "updatedAt" }>
> {
	declare name: string;
