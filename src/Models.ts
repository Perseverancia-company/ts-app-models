...
import UserContactMethods, {
	createUserContactMethods,
} from "./model/user/UserContactMethods";
...
import UserMessages, {
	createUserMessagesModel,
} from "./model/real-estate/UserMessages";
import Property, { createPropertyModel } from "./model/real-estate/Property";
import DebugPropertyImageUpload, {
	createDebugPropertyImageUpload,
} from "./model/real-estate/DebugPropertyImageUpload";
import PropertySellerMessage, {
	createPropertySellerMessage,
} from "./model/real-estate/PropertySellerMessage";
import PropertyComment, {
	createPropertyComment,
} from "./model/real-estate/PropertyComment";
import PropertyRating, {
	createPropertyRating,
} from "./model/real-estate/PropertyRating";
import UserFavoriteProperty, {
	createUserFavoriteProperty,
} from "./model/real-estate/UserFavoriteProperty";
import GeneralPropertyInformation, {
	createGeneralPropertyInformationModel,
} from "./model/real-estate/GeneralPropertyInformation";
...
import InvoiceProductJunction, {
	createInvoiceProductJunctionModel,
} from "./model/crm/InvoiceProductJunction";
...
import MeetiParticipants, {
	createMeetiParticipantsModel,
} from "./model/meetup/MeetiParticipants";
import Comment, { createCommentModel } from "./model/meetup/Comment";
import SocialCategory, {
	createSocialCategoryModel,
} from "./model/meetup/SocialCategory";
...
import GroupAppJunction, {
	createGroupAppJunction,
} from "./model/app/GroupAppJunction";
import TagAppJunction, {
	createTagAppJunction,
} from "./model/app/TagAppJunction";
import EmployeeRole, {
	createEmployeeRoleModel,
} from "./model/company/EmployeeRole";
import CompanyStaff, {
	createCompanyStaffModel,
} from "./model/company/CompanyStaff";
import Skill, { createSkillModel } from "./model/company/Skill";
import JobSkillJunction, {
	createJobSkillJunction,
} from "./model/company/JobSkillJunction";
import Music, { createMusicModel } from "./model/personal-log/Music";
import Note, { createNoteModel } from "./model/personal-log/Note";
import PersonalLog, {
	createPersonalLogModel,
} from "./model/personal-log/PersonalLog";
import ListeningTo, {
	createListeningToModel,
} from "./model/personal-log/ListeningTo";
...
import FolderFileJunction, {
	createFolderFileJunctionModel,
} from "./model/file/FolderFileJunction";
import DuplicatedFile, {
	createDuplicatedFileModel,
} from "./model/file/DuplicatedFile";
import ByteRegion, { createByteRegionModel } from "./model/file/ByteRegion";
import StorageDevice, {
	createStorageDeviceModel,
} from "./model/system-info/StorageDevice";
import SystemMemory, {
	createSystemMemoryModel,
} from "./model/system-info/SystemMemory";
import SystemCore, {
	createSystemCoreModel,
} from "./model/system-info/SystemCore";
import SystemResources, {
	createSystemResourcesModel,
} from "./model/system-info/SystemResources";
import ServerNode, {
	createServerNodeModel,
} from "./model/system-info/ServerNode";
import ServerLocation, {
	createServerLocation,
} from "./model/system-info/ServerLocation";
import SystemInfo, {
	createSystemInfoModel,
} from "./model/system-info/SystemInfo";
...
} from "./model/oauth/OAuthAccessToken";
...
export default class Models {
	...
	constructor(options?: { connection: Sequelize }) {
		...
		this.UserContactMethods = createUserContactMethods(
			this.connection,
			this.User
		);
		...
		// Company
		this.Company = createCompanyModel(this.connection, this.Address);
		...
		// Job(Dev jobs)
		this.Job = createJobModel(this.connection, this.Company);
		this.Skill = createSkillModel(this.connection);
		...
		// CRM
		this.Product = createProductModel(this.connection);

		this.Invoice = createInvoiceModel(this.connection, this.User);
		...
		this.PersonalLog = createPersonalLogModel(
			this.connection,
			this.Address
		);
		this.ListeningTo = createListeningToModel(
			this.connection,
			this.Music,
			this.PersonalLog
		);
		this.LogNotes = createLogNotesModel(
			this.connection,
			this.PersonalLog,
			this.Note
		);
		...
		this.SystemResources = createSystemResourcesModel(this.connection);
		...
		this.ServerLocation = createServerLocation(this.connection);
		this.SystemInfo = createSystemInfoModel(this.connection);
